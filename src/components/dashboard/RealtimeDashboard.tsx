    ...
    <div className="flex flex-col gap-6 pb-20 md:pb-0 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        <div className="stat-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-bold text-[var(--color-text-primary)]">{productCount ?? 0}</p>
                ...
                >
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-[var(--color-text-primary)] truncate">
                      {(Array.isArray(sale.profiles) ? sale.profiles[0]?.full_name : sale.profiles?.full_name) ?? "Cashier"}
                    </p>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className={cn("badge", PRODUCT_TYPE_COLORS[p.type as keyof typeof PRODUCT_TYPE_COLORS])}>
                  ...
                  <div className="text-right shrink-0 ml-3">
                    <p className={cn("text-sm font-bold", p.total_stock === 0 ? "text-danger" : "text-warning")}>
                      {p.total_stock ?? 0}
                    </p>
      ...
      <div className="card p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { href: "/pos", label: "New Sale", icon: ShoppingBag, iconBg: "bg-brand-500/10", iconColor: "text-brand-400" },
            { href: "/inventory/new", label: "Add Product", icon: Plus, iconBg: "bg-success/10", iconColor: "text-success" },
            { href: "/inventory/movements", label: "Stock In", icon: ArrowUpRight, iconBg: "bg-info/10", iconColor: "text-info" },
            { href: "/sales", label: "View Reports", icon: BarChart2, iconBg: "bg-purple-500/10", iconColor: "text-purple-400" },
