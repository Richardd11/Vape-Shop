...
CREATE TABLE IF NOT EXISTS public.product_variants (
  ...
  nicotine_strength   TEXT,     -- e.g. '3mg', '6mg', '50mg', 'freebase', 'salts'
  size_ml             NUMERIC,  -- e.g. 30, 60, 100
  puff_count          INTEGER,  -- for disposables
  device_compat       TEXT,     -- for pods
...
CREATE TABLE IF NOT EXISTS public.sale_items (
  ...
  variant_label   TEXT,            -- snapshot at time of sale
...
CREATE TABLE IF NOT EXISTS public.inventory_movements (
  ...
  notes           TEXT,
  reference_id    UUID,               -- sale_id for sale movements
